...
Project-local cache path: `.agents/skills/amiga-sdk-docs/cache/amigasdk-gcc`
...
2. Sync the cached SDK clone by running `./.agents/skills/amiga-sdk-docs/scripts/sync-repo.sh` from the repo root.
...
- Do not commit anything under `.agents/skills/amiga-sdk-docs/cache/`.

## Fallback order

1. Local SDK cache at `.agents/skills/amiga-sdk-docs/cache/amigasdk-gcc`
