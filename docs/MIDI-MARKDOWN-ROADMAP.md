...
3. **Platzhalter `[Codeblock n]` → Code-Viewer (Doppelklick):** **offen** — `codeBlocksViewerOpenAtIndex()` vorhanden; Doppelklick im Chat fehlt. Verworfene MUI-Ansätze: [PHASE-12-CHAT-SCINTILLA.md](PHASE-12-CHAT-SCINTILLA.md#3a--doppelklick-auf-codeblock-n-offen). Export/raw unverändert.
