            ...
            WindowContents, VGroup,
                ...
                Child, VGroup,
                    ...
                    Child, elevenLabsAPIKeyString = StringObject,
                        ...
                        MUIA_String_Contents, config.elevenLabsAPIKey,
                    End,
                End,
                /* Model Section */
                Child, VGroup,
                    ...
                    Child, NListviewObject,
                        MUIA_NListview_NList, elevenLabsModelList = NListObject,
                            MUIA_NList_ConstructHook2, &ConstructModelLI_TextHook,
                            MUIA_NList_DestructHook2, &DestructModelLI_TextHook,
                            MUIA_NList_DisplayHook2, &DisplayModelLI_TextHook,
                            MUIA_NList_Format, "",
                ...
                Child, VGroup,
                    ...
                    Child, NListviewObject,
                        MUIA_NListview_NList, elevenLabsVoiceList = NListObject,
                            MUIA_NList_ConstructHook2, &ConstructVoiceLI_TextHook,
                            MUIA_NList_DestructHook2, &DestructVoiceLI_TextHook,
                            MUIA_NList_DisplayHook2, &DisplayVoiceLI_TextHook,
                            MUIA_NList_Format, "",
                            MUIA_NList_Title, FALSE,
                            MUIA_NList_MinLineHeight, 16,
                        End,
                ...
                /* Buttons */
                Child, HGroup,
                    Child, elevenLabsSettingsOkButton = MUI_MakeObject(MUIO_Button, STRING_OK,
                        MUIA_Background, MUII_FILL,
                        MUIA_CycleChain, TRUE,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                    End,
                    Child, elevenLabsSettingsCancelButton = MUI_MakeObject(MUIO_Button, STRING_CANCEL,
                        MUIA_Background, MUII_FILL,
                        MUIA_CycleChain, TRUE,
                        MUIA_InputMode, MUIV_InputMode_RelVerify,
                    End,
