...
LONG createMainWindow() {
	...
	Object *textObject = TextObject,
        MUIA_Text_Contents,  "Click Me",          // Button label text
        MUIA_Text_PreParse, "\33c",               // Control code to set color
        MUIA_Font,      (ULONG) MUIV_Font_Button, // Use button font
        End;
