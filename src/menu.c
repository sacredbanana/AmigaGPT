...
void refreshChatFontMenuState(void) {
    ...
    if (larger != NULL) {
        set(larger, MUIA_Menuitem_Enabled,
            configGetChatFontSize() < CHAT_OUTPUT_FONT_SIZE_MAX);
    }
    if (smaller != NULL) {
        set(smaller, MUIA_Menuitem_Enabled,
            configGetChatFontSize() > CHAT_OUTPUT_FONT_SIZE_MIN);
    }
}
#endif
...
HOOKPROTONHNONP(MarkdownFormattingMenuItemClickedFunc, void) {
    configSetMarkdownFormatting(!configGetMarkdownFormatting());
    DoMethod(app, MUIM_Application_PushMethod, app, 2, MUIM_CallHook,
             &MarkdownRefreshHook);
}
...
HOOKPROTONHNONP(ChatLineWrapMenuItemClickedFunc, void) {
    configSetChatLineWrap(!configGetChatLineWrap());
...
HOOKPROTONHNONP(ChatFontLargerMenuItemClickedFunc, void) {
    ULONG size = configGetChatFontSize();
    if (size >= CHAT_OUTPUT_FONT_SIZE_MAX) {
        return;
    }
    configSetChatFontSize(configClampChatFontSize(size + 1));
...
void createMenu() {
    ...
    menuStrip = MenustripObject,
        ...
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_PROJECT,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_PRINT,
                MUIA_UserData, MENU_ITEM_PROJECT_PRINT,
                MUIA_Menuitem_CopyStrings, FALSE,
                MUIA_Menuitem_Shortcut, "P",
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, NM_BARLABEL,
                MUIA_UserData, MENU_ITEM_NULL,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_ABOUT_AMIGAGPT,
                MUIA_UserData, MENU_ITEM_PROJECT_ABOUT_AMIGAGPT,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_ABOUT_MUI,
                MUIA_UserData, MENU_ITEM_PROJECT_ABOUT_MUI,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, NM_BARLABEL,
            ...
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_QUIT,
                MUIA_UserData, MENU_ITEM_PROJECT_QUIT,
        ...
        /* Edit Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_EDIT,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CUT,
                MUIA_UserData, MENU_ITEM_EDIT_CUT,
                MUIA_Menuitem_Shortcut, "X",
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_COPY,
                MUIA_UserData, MENU_ITEM_EDIT_COPY,
                MUIA_Menuitem_Shortcut, "C",
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_PASTE,
                MUIA_UserData, MENU_ITEM_EDIT_PASTE,
                MUIA_Menuitem_Shortcut, "V",
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CLEAR,
                MUIA_UserData, MENU_ITEM_EDIT_CLEAR,
                MUIA_Menuitem_Shortcut, "L",
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_SELECT_ALL,
                MUIA_UserData, MENU_ITEM_EDIT_SELECT_ALL,
            ...
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_FIND,
                MUIA_UserData, MENU_ITEM_EDIT_FIND,
                MUIA_Menuitem_Shortcut, "F",
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_FIND_NEXT,
                MUIA_UserData, MENU_ITEM_EDIT_FIND_NEXT,
        ...
        /* View Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_VIEW,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_FIXED_WIDTH_FONTS,
                MUIA_UserData, MENU_ITEM_VIEW_FIXED_WIDTH_FONTS,
                MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Toggle, TRUE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_MARKDOWN_FORMATTING,
                MUIA_UserData, MENU_ITEM_VIEW_MARKDOWN_FORMATTING,
                MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Toggle, TRUE,
            End,
#ifdef __MORPHOS__
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CHAT_LINE_WRAP,
                MUIA_UserData, MENU_ITEM_VIEW_CHAT_LINE_WRAP,
                MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Toggle, TRUE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CHAT_FONT_LARGER,
                MUIA_UserData, MENU_ITEM_VIEW_CHAT_FONT_LARGER,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CHAT_FONT_SMALLER,
                MUIA_UserData, MENU_ITEM_VIEW_CHAT_FONT_SMALLER,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
#endif
#ifndef __MORPHOS__
            ...
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_USER_TEXT_ALIGNMENT,
                MUIA_UserData, MENU_ITEM_VIEW_USER_TEXT_ALIGNMENT,
                MUIA_Menuitem_CopyStrings, FALSE,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_TEXT_ALIGNMENT_LEFT,
                    MUIA_UserData, MENU_ITEM_VIEW_USER_TEXT_ALIGNMENT_LEFT,
                    MUIA_Menuitem_CopyStrings, FALSE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_Checked, configGetUserTextAlignment() == ALIGN_LEFT,
                    MUIA_Menuitem_Exclude, ~(1 << 0),
                    MUIA_Menuitem_Toggle, TRUE,
                End,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_TEXT_ALIGNMENT_CENTER,
                    MUIA_UserData, MENU_ITEM_VIEW_USER_TEXT_ALIGNMENT_CENTER,
                    MUIA_Menuitem_CopyStrings, FALSE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_Checked, configGetUserTextAlignment() == ALIGN_CENTER,
                    MUIA_Menuitem_Exclude, ~(1 << 1),
                    MUIA_Menuitem_Toggle, TRUE,
                End,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_TEXT_ALIGNMENT_RIGHT,
                    MUIA_UserData, MENU_ITEM_VIEW_USER_TEXT_ALIGNMENT_RIGHT,
                    MUIA_Menuitem_CopyStrings, FALSE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_Checked, configGetUserTextAlignment() == ALIGN_RIGHT,
                    MUIA_Menuitem_Exclude, ~(1 << 2),
                    MUIA_Menuitem_Toggle, TRUE,
                End,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_ASSISTANT_TEXT_ALIGNMENT,
                MUIA_UserData, MENU_ITEM_VIEW_ASSISTANT_TEXT_ALIGNMENT,
                MUIA_Menuitem_CopyStrings, FALSE,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_TEXT_ALIGNMENT_LEFT,
                    MUIA_UserData, MENU_ITEM_VIEW_ASSISTANT_TEXT_ALIGNMENT_LEFT,
                    MUIA_Menuitem_CopyStrings, FALSE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_Checked, configGetAssistantTextAlignment() == ALIGN_LEFT,
                    MUIA_Menuitem_Exclude, ~(1 << 0),
                    MUIA_Menuitem_Toggle, TRUE,
                End,
                MUIA_Family_Child, MenuitemObject,
                ...
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_TEXT_ALIGNMENT_RIGHT,
                    MUIA_UserData, MENU_ITEM_VIEW_ASSISTANT_TEXT_ALIGNMENT_RIGHT,
                    MUIA_Menuitem_CopyStrings, FALSE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_Checked, configGetAssistantTextAlignment() == ALIGN_RIGHT,
                    MUIA_Menuitem_Exclude, ~(1 << 2),
                    MUIA_Menuitem_Toggle, TRUE,
                End,
            End,
            ...
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_MUI_SETTINGS,
                MUIA_UserData, MENU_ITEM_VIEW_MUI_SETTINGS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_CLEAR_MUI_SETTINGS,
                MUIA_UserData, MENU_ITEM_VIEW_CLEAR_MUI_SETTINGS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
#ifdef __MORPHOS__
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_VIEW_CODEBLOCKS,
                MUIA_UserData, MENU_ITEM_VIEW_CODEBLOCKS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_EXPORT_CHAT_RAW,
                MUIA_UserData, MENU_ITEM_VIEW_EXPORT_CHAT_RAW,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
#endif
        ...
        /* Connection Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_CONNECTION,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_PROXY,
                MUIA_Menuitem_CopyStrings, FALSE,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_ENABLED,
                    MUIA_UserData, MENU_ITEM_CONNECTION_PROXY_ENABLED,
                    MUIA_Menuitem_Toggle, TRUE,
                    MUIA_Menuitem_Checkit, TRUE,
                    MUIA_Menuitem_CopyStrings, FALSE,
                End,
                MUIA_Family_Child, MenuitemObject,
                    MUIA_Menuitem_Title, STRING_MENU_SETTINGS,
                    MUIA_UserData, MENU_ITEM_CONNECTION_PROXY_SETTINGS,
                    MUIA_Menuitem_CopyStrings, FALSE,
                End,
            End,
        End,
        ...
        /* Chat Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_CHAT,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_CHAT_PROVIDER_SETTINGS,
                MUIA_UserData, MENU_ITEM_CHAT_PROVIDER_SETTINGS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
        End,
        ...
        /* Image Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_IMAGE,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_IMAGE_PROVIDER_SETTINGS,
                MUIA_UserData, MENU_ITEM_IMAGE_PROVIDER_SETTINGS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
        End,
        ...
        /* Speech Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_SPEECH,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_ENABLED,
                MUIA_UserData, MENU_ITEM_SPEECH_ENABLED,
                MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Toggle, TRUE,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            ...
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_SPEECH_PROVIDER_SETTINGS,
                MUIA_UserData, MENU_ITEM_SPEECH_PROVIDER_SETTINGS,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
        End,
        ...
        /* ARexx Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_AREXX,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_AREXX_AREXX_SHELL,
                MUIA_UserData, MENU_ITEM_AREXX_AREXX_SHELL,
                MUIA_Menuitem_CopyStrings, FALSE,
                MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Toggle, TRUE,
            End,
            ...
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_AREXX_IMPORT_SCRIPT,
                MUIA_UserData, MENU_ITEM_AREXX_IMPORT_SCRIPT,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_AREXX_RUN_SCRIPT,
                MUIA_UserData, MENU_ITEM_AREXX_RUN_SCRIPT,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
        End,
        ...
        /* Help Menu */
        MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, STRING_MENU_HELP,
            MUIA_Menu_CopyStrings, FALSE,
            MUIA_Family_Child, MenuitemObject,
                MUIA_Menuitem_Title, STRING_MENU_OPEN_DOCUMENTATION,
                MUIA_UserData, MENU_ITEM_HELP_OPEN_DOCUMENTATION,
                MUIA_Menuitem_CopyStrings, FALSE,
            End,
        End,
    End;
...
void addMenuActions() {
    ...
    set(chatLineWrapMenuItem, MUIA_Menuitem_Checked, configGetChatLineWrap());
                ...
                while (ExNext(lock, fib)) {
                    ...
                    if (len > 5 && !stricmp(&filename[len - 5], ".rexx")) {
                        ...
                        Object *newScriptMenuItem = MenuitemObject,
                            ...
                            MUIA_UserData, (APTR)MENU_ITEM_AREXX_SCRIPT,
                        End;
                        // clang-format on
...
// Optionally copy the caller's current shell path (duplicates the locks).
    ...
    /* Note: current directory and C: are implicit; don't add them yourself. C:
     * is always searched last, current dir always first */
