...
static struct NewMenu amigaGPTMenu[] = {
    ...
    {NM_SUB, "Enabled", 0, CHECKIT | CHECKED, 0,
    ...
    {NM_ITEM, "Enabled", 0, CHECKIT | CHECKED, 0,
     (APTR)MENU_ITEM_SPEECH_ENABLED},
    {NM_ITEM, "Speech system", 0, 0, 0, (APTR)MENU_ITEM_NULL},
#ifdef __AMIGAOS3__
    {NM_SUB, "Workbench 1.x v34", 0, CHECKIT | CHECKED, ~16,
     (APTR)MENU_ITEM_SPEECH_SYSTEM_34},
    {NM_SUB, "Workbench 2.0 v37", 0, CHECKIT, ~16,
     (APTR)MENU_ITEM_SPEECH_SYSTEM_37},
#else
#ifdef __AMIGAOS4__
    {NM_SUB, "Flite", 0, CHECKIT | CHECKED, ~16,
     (APTR)MENU_ITEM_SPEECH_SYSTEM_FLITE},
#endif
#endif
    {NM_SUB, "OpenAI Text To Speech", 0, CHECKIT, ~16,
...
void addMenuActions() {
    ...
    Object openAIChatModelo1Pewview2024_09_12MenuItem =
        (Object)DoMethod(menuStrip, MUIM_FindUData,
                         MENU_ITEM_OPENAI_CHAT_MODEL_o1_PREVIEW_2024_09_12);
    set(openAIChatModelo1Pewview2024_09_12MenuItem, MUIA_Menuitem_Checked,
        config.chatModel == o1_PREVIEW_2024_09_12);
    DoMethod(openAIChatModelo1Pewview2024_09_12MenuItem, MUIM_Notify,
             MUIA_Menuitem_Checked, TRUE, MUIV_Notify_Application, 3,
